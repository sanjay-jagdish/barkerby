...
// get date past from ajax script
	$date_selected = strip_tags(mysql_real_escape_string($_GET['date']));
	// echo $date_selected;
...
.hour_th{ font-weight: lighter !important; color:#000 !important; background-color:#EAEAEA !important; padding:2px !important; }
.min_th{ font-weight: lighter !important; color:#000 !important; background-color:#fff !important; padding:2px !important; }
...
<div style="text-align:center;">
    ...
    <div style="float:left; margin-top:-6px;">
      ...
      <?php 
		...
		?>
      <div id="waiting_list_link" style="float:left; background-color:#FFF; margin:0px; height:20px; border-top: solid 2px #fc9;  border-bottom: solid 2px #fc9; padding:3px;"> <?php echo $waitlist_report; ?> </div>
...
<div id="operation_details" style="float:left; width:210px; padding:0px 8px 8px 20px; line-height:15px;">
	...
	<div style="width:200px; border: solid thin 1px; margin-top:4px;">
        ...
        <table class="booking_summary" style="background-color:#CCC; border-collapse:collapse; border-color:#CCC;" width="100%" border="1">
        	...
        	<tbody>
            	<tr>
                	<td align="center" bgcolor="#FFFFFF"><?php echo number_format($lunch['bookings'],0); ?></td>
                	<td align="center" bgcolor="#FFFFFF"><?php echo number_format($dinner['bookings'],0); ?></td>
                	<td align="center" bgcolor="#FFFFFF"><?php echo number_format(($lunch['bookings']+$dinner['bookings']),0); ?></td>
                </tr>
            </tbody>
        </table>
    </div>
        	...
        	<thead>
				...
				while($time_h<=$end_h){
					if(date('i',$time_h)=='00'){
						...
						$class_th = '';
                    ?>
				  <th style="width:70px; line-height:10px; font-size:10px !important; text-align:center; vertical-align:middle;text-align:left !important; padding-left:0px !important" class="<?php echo $class_th; ?>" colspan="<?php echo $hr_span; ?>">
					<?php 
					echo $time_txt_h;
					?>
                    </th>
