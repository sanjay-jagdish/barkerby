...
?> 
<div class="special_request_menu <?php echo getMenuImage($r['menu_id'])!='' ? 'hasImg':''; ?>" data-check="<?php echo $_POST['check']; ?>">
<?php 
...
jQuery(function(){
	...
	var check = "<?php echo $_POST['check']; ?>";
   ...
   jQuery('#btn_skip').click(function(){
	  ...
	  jQuery.ajax({
		...
		type: 'POST',
		data: 'menu_id='+encodeURIComponent(menu_id)+'&uniq='+encodeURIComponent(uniq)+'&notes='+encodeURIComponent(notes)+'&res_detail_id='+encodeURIComponent(resid)+'&addons='+encodeURIComponent(addons)+'&thetemptillval='+encodeURIComponent('<?php echo thetemptillval; ?>'),
   ...
   jQuery('.remove-tillval').click(function(){
		...
		var dishnum = jQuery(this).attr('data-count');
		
		var uniq = jQuery('#btn_skip').attr('data-rel');
		...
		var orig_item_price=Number(jQuery('.reqtotal').attr('data-price'));
		getOptionTotal(orig_item_price);
		
		var current_total_price = Number(jQuery('.reqtotal label').attr('data-total'));
		
		jQuery('.reqtotal label').attr('data-total', (current_total_price - orig_item_price));
		
		jQuery.ajax({
			url: siteurl+"/update-quantity.php",
			type: 'POST',
			async: false,
			data: 'id='+encodeURIComponent(id)+'&type='+encodeURIComponent(type)+'&dishnum='+encodeURIComponent(dishnum)+'&uniq='+encodeURIComponent(uniq),
			success: function(value){
