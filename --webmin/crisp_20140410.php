...
<script type="text/javascript">
	...
	/*function fadeInOut() {
			 ...
			 jQuery('.blink').fadeIn(2000, function () {
				jQuery('.blink').fadeOut(2000, function () {
					jQuery('.blink').fadeIn(2000, function () {
	...
	<div class="header-wrapper">
    	<div class="header">
            ...
            <div class="header-nav">
                ...
                <img src="images/logo-limone.png" style="margin:7px 0 0;">
            </div>
            <!-- end .header-nav -->
            <div class="header-account">
                ...
                <div class="account-details">
                	<ul>
                        ...
                        <li><a href="?page=profile&subpage=edit-profile">Ändra min profil</a></li>
                        <!--<li><a href="?page=account-settings">Account Settings</a></li>-->
                        <li><a href="actions/logout.php">Logga ut</a></li>
                    </ul>
                </div>
            </div>
            <!-- end .header-account -->
    ...
    <div class="nav-wrapper">
    	<div class="nav">
        	<ul>
            	...
            	<li class="nav-dashboard navs"><a href="?page=dashboard" class="dashboard-li">Kontrollpanel</a></li>
                <li class="nav-menu navs <?php echo showNav($nav_menu,'category*sub_category'); ?>"><a href="?page=menu" class="menu-li main">Menyer</a>
                	<ul>
                        ...
                        <li class="nav-category navs <?php echo showNav($nav_subcategory,''); ?>" data-rel="nav-menu"><a href="?page=subcategory&parent=menu">Sub Kategori</a></li>
                    </ul>
                </li>
                <li class="nav-reservation navs <?php echo showNav($nav_reservation,'overview*order_status'); ?>"><a href="?page=orders" class="orders-li main">Bokningar</a>
                	<ul>
                        <li class="nav-overview navs <?php echo showNav($nav_overview,''); ?>"><a href="?page=dashboard&overview=1">Boken</a></li>
                ...
                <li class="nav-the_staff navs <?php echo showNav($nav_the_staff,'users*announcement*shift_request*scheduler*scheduler_chart'); ?>"><a href="?page=users&parent=staff" class="users-li main">Personal</a>
                	<ul>
                       ...
                       <?php }else{ ?>
                        <li class="nav-scheduler_chart navs <?php echo showNav($nav_scheduler_chart,''); ?>"><a href="?page=scheduler-chart-user&parent=staff">Schema</a></li>
					   <?php }?>
                    </ul>
                </li>
                <li class="nav-reports navs <?php echo showNav($nav_reports,'logs'); ?>"><a href="?page=reports" class="reports-li main">Rapporter</a>
                	<ul>
