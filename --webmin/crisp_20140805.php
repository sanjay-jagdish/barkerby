	...
	jQuery(function(){
		...
		setInterval(function(){ 
			...
			if(jQuery('.orders-page .sound').length > 0){
				jQuery('#notificationAudio')[0].play(); 
			}
    	...
    	<div class="header">
            ...
            <div class="header-account">
                ...
                <div class="account-details">
                	<ul>
                    	<li><span><?php echo $_SESSION['login']['name']; ?></span></li>
    ...
    <div class="nav-wrapper">
    	<div class="nav">
        	<ul>
            	...
            	<li class="nav-dashboard navs"><a href="?page=dashboard" class="dashboard-li">Dashboard</a></li>
            	<li class="nav-controlpanel navs"><a href="?page=controlpanel" class="controlpanel-li">Kontrollpanel</a></li>
                <li class="nav-menu navs <?php echo showNav($nav_menu,'category*sub_category'); ?>"><a href="?page=menu" class="menu-li main">Menyer</a>
                	<ul>
                    	<li class="nav-category navs <?php echo showNav($nav_category,''); ?>" data-rel="nav-menu"><a href="?page=category&parent=menu">Kategori</a></li>
                        <li class="nav-subcategory navs <?php echo showNav($nav_subcategory,''); ?>" data-rel="nav-menu"><a href="?page=subcategory&parent=menu">Sub Kategori</a></li>
                    </ul>
                </li>
                <li class="nav-catering navs"><a href="?page=catering" class="catering-li <?php echo showNav($nav_catering,''); ?>">Catering</a>
                	<ul>
                    	<li class="nav-catering_category navs <?php echo showNav($nav_catering_category,''); ?>" data-rel="nav-catering"><a href="?page=catering-category&parent=catering">Kategori</a></li>
                        <li class="nav-catering_subcategory navs <?php echo showNav($nav_catering_subcategory,''); ?>" data-rel="nav-catering"><a href="?page=catering-subcategory&parent=catering">Sub Kategori</a></li>
                        <li class="nav-catering_menu navs <?php echo showNav($nav_catering_menu,''); ?>" data-rel="nav-catering"><a href="?page=catering-menu&parent=catering">Catering Menu</a></li>
                ...
                <li class="nav-reservation navs <?php echo showNav($nav_reservation,'overview*order_status'); ?>"><a href="?page=orders" class="orders-li main">Bokningar</a>
                	<ul>
                        <li class="nav-overview navs <?php echo showNav($nav_overview,''); ?>"><a href="?page=controlpanel&overview=1">Boken</a></li>
                        <li class="nav-order_status navs <?php echo showNav($nav_order_status,''); ?>"><a href="?page=order-status&parent=orders">Beställningsstatus</a></li>
                      
                    </ul>	
                </li>
                <li class="nav-customers navs <?php echo showNav($nav_customers,''); ?>"><a href="?page=customers" class="customers-li">Gäster</a></li>
                <li class="nav-the_staff navs <?php echo showNav($nav_the_staff,'users*announcement*shift_request*scheduler*scheduler_chart'); ?>"><a href="?page=users&parent=staff" class="users-li main">Personal</a>
                	<ul>
                        <li class="nav-users navs <?php echo showNav($nav_users,''); ?>"><a href="?page=users&parent=staff">Användare</a></li>
                       ...
                       <?php }else{ ?>
                        <li class="nav-scheduler_chart navs"><a href="?page=scheduler-chart-user&parent=staff">Schema</a></li>
					   <?php }?>
                    </ul>
                </li>
                <li class="nav-reports navs <?php echo showNav($nav_reports,'logs*booking_report'); ?>"><a href="?page=reports" class="reports-li main">Rapporter</a>
                	<ul>
                ...
                <li class="nav-settings navs <?php echo showNav($nav_settings,'tables*table_masterlist*floorplan*account*advanced_settings'); ?>"><a href="?page=tables&parent=settings" class="tables-li main">Inställningar</a>
                	<ul>
                        <li class="nav-tables navs <?php echo showNav($nav_tables,''); ?>"><a href="?page=tables&parent=settings">Bordsintervaller</a></li>
                        <li class="nav-tables navs <?php echo showNav($nav_table_masterlist,''); ?>"><a href="?page=table-masterlist&parent=settings">Bordsinställning</a></li>
                        <li class="nav-floorplan navs <?php echo showNav($nav_floorplan,''); ?>"><a href="?page=floorplan&parent=settings">Bordsplan</a></li>
                        <li class="nav-account navs <?php echo showNav($nav_account,''); ?>"><a href="?page=account&parent=settings">Rättigheter</a></li>
                        <!--<li><a href="?page=currency&parent=settings">Currency</a></li>-->
                ...
                <li class="nav-notifications navs <?php echo showNav($nav_notifications,''); ?>"><a href="?page=notifications" class="notifications-li">Push-notiser</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="content-wrapper">
    	<div class="content">
            ...
            <div class="content-container">
                ...
                <!-- end .content-area -->
                <div class="footer">
                	<p>&copy; Copyright <?php echo date('Y'); ?> ICINGTON GROUP. All Rights Reserved.</p>
                </div>
            </div>
