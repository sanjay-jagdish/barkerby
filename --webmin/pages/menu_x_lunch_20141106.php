		...
		CKEDITOR.on( 'instanceCreated', function( event ) {
			...
			if ( element.is( 'div' ) ) {
				...
				editor.on( 'configLoaded', function() {
					...
					editor.config.removePlugins = 'flash,font,' +
    ...
    <div style="float:right; width: 170px; text-align:center;">
        ...
        <table>
            <tr>
                ...
                <td><div id="text_over_menu" contenteditable="true"><?php echo stripslashes($menu_week_res['note_header']); ?></div></td>
            </tr>
          <tr>
              <td align="left" style="font-family: 'Roboto'; color:#000;">Menu Description:</td>
              <td><span class="menu_description" style="width:100%">
                <div class="menu_main_description" contenteditable="true"><?php echo stripslashes($menu_week_res['description']); ?></div>	
              </span></td>
            </tr>
          <tr>
            ...
            <td><span style="clear:both; clear:both;">
              <div id="text_after_menu" contenteditable="true"><?php echo stripslashes($menu_week_res['note_footer']); ?></div>
            </span></td>
          </tr>
        </table>    
    </div>
