                ...
                <tbody>
                 <?php
					...
					for($i=0;$i<count($getorders);$i++){
						...
						if(getCoursesCount($getorders[$i]['rid'])>0){
                 ?>
