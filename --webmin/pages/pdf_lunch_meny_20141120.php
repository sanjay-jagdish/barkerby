...
<div style="text-align:center;"  class="themenu-outer">
    ...
    <h1>Vecka <?php echo $week_num; ?></h1>    
	<br>
    <br>

    <strong><?php echo stripslashes($menu_week_res['note_header']); ?></strong>
    
	<p><?php echo stripslashes($menu_week_res['description']); ?>

    <img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/webmin/images/separator.png">
	...
	if($courses_num>0){
		...
		?>
            ...
            <p><b><?php echo stripslashes($courses_res['name']); ?></b>
