...
<div style="background-color:#FFC; padding:10px 15px; overflow:hidden; display:none;"> OBS! Gäller hela vecka <?php echo $week_num; ?> (mån-fre)
	...
	echo $header_monfri_sql.'<br>';

	?>    
    
		<input type="checkbox" id="mon_fri_header" data-rel="<?php echo $header_monfri['id']; ?>" <?php if($header_monfri['show']==1){ echo 'checked="checked"'; } ?> />
    	Visa Mån-Fr Text ovanför menyn
		<input type="checkbox" id="mon_fri_header_allin" <?php if($header_monfri['all_in']==1){ echo 'checked="checked"'; } ?> />
    	Gäller alla veckor
        <div class="mon_fri_header header_footer" <?php if($update_lock==0){ echo 'contenteditable="true"'; } ?>><?php echo stripslashes($header_monfri['contents']); ?></div>
	...
	*/
	...
	?>
		...
		<input type="checkbox" id="mon_fri_footer" data-rel="<?php echo $footer_monfri['id']; ?>" <?php if($footer_monfri['show']==1){ echo 'checked="checked"'; } ?> /> 
		Visa Mån-Fr Text nedanför menyn  
		<input type="checkbox" id="mon_fri_footer_allin" <?php if($footer_monfri['all_in']==1){ echo 'checked="checked"'; } ?> />
    	Gäller alla veckor
        <div class="mon_fri_footer header_footer" <?php if($update_lock==0){ echo 'contenteditable="true"'; } ?>><?php echo stripslashes($footer_monfri['contents']); ?></div>
    ...
    <input type="checkbox" id="<?php echo strtolower(date('D', $the_day)); ?>_header" data-rel="<?php echo $notes['id']; ?>" <?php if($header['show']==1){ echo 'checked="checked"'; } ?> /> 
    ...
    <div class="<?php echo strtolower(date('D', $the_day)); ?>_header header_footer" <?php if($update_lock==0){ echo 'contenteditable="true"'; } ?>><?php echo stripslashes($header['contents']); ?></div>
	...
	<?php }//end-of only show add button if update_lock is not enabled ?>
        ...
        <input type="checkbox" id="<?php echo strtolower(date('D', $the_day)); ?>_footer" data-rel="<?php echo $footer_monfri['id']; ?>" <?php if($footer_monfri['show']==1){ echo 'checked="checked"'; } ?> /> 
        ...
        Gäller alla <?php echo dayName(date('D', $the_day)); ?>
        <div class="<?php echo strtolower(date('D', $the_day)); ?>_footer header_footer" <?php if($update_lock==0){ echo 'contenteditable="true"'; } ?>><?php echo stripslashes($footer_monfri['contents']); ?></div>
