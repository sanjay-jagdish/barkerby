...
function save_updates(){
	...
	$(".course_desc_existing").each(function(){
		...
		var val_desc = $(this).html().trim().replace(/[\u200B-\u200D\uFEFF]/g, '');
		var id = $(this).attr('id');
		var id_data = id.split('_');
		var name = $('#course_name_existing_'+id_data[1]).html().replace(/[\u200B-\u200D\uFEFF]/g, '');		
	...
	$(".additional_course_desc").each(function(){
		...
		var id = $(this).attr('id')+'';
		var id_data = id.split('_');
		var name = $('#additional_course_name_'+id_data[1]).html().trim().replace(/[\u200B-\u200D\uFEFF]/g, '');		
		var lmta_price = 0;
		var parameter_check = 0;
