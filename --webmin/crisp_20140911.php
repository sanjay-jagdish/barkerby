    ...
    <div class="nav-wrapper">
    	<div class="nav">
        	<ul>
            	...
            	<li class="nav-dashboard navs"><a href="?page=dashboard" class="dashboard-li">Home</a></li>
            	<li class="nav-controlpanel navs"><a href="?page=controlpanel" class="controlpanel-li">Boken</a></li>
                <li class="nav-reservation navs"><a href="?page=orders" class="orders-li">Beställningar</a></li>
                ...
                <li class="nav-takeaway navs"><a href="javascript:void(0)" class="takeaway-li">Take away</a>
                	<ul>
                    	<li class="nav-takeawaymenu navs" data-rel="nav-takeaway"><a href="?page=takeaway-menu&parent=takeaway">Menynställningar</a></li>
                ...
                <li class="nav-catering navs"><a href="?page=catering" class="catering-li <?php echo showNav($nav_catering,''); ?>">Catering</a>
                	<ul>
                        <li class="nav-catering_menu navs <?php echo showNav($nav_catering_menu,''); ?>" data-rel="nav-catering"><a href="?page=catering-menu&parent=catering">Menynställningar</a></li>
                ...
                <li class="nav-lunchmeny navs"><a href="javascript:void(0)" class="lunchmeny-li">Lunchmeny</a>
                	...
                	<ul>
                        <li class="nav-lunch_menu navs <?php echo showNav($nav_catering_menu,''); ?>" data-rel="nav-lunchmeny"><a href="?page=lunch-menu&parent=lunchmeny">Menynställningar</a></li>
                         <li class="nav-logs navs <?php echo showNav($nav_logs,''); ?>"><a href="?page=logs&parent=reports">Logg</a></li>
                    </ul>
                ...
                <li class="nav-alacarte navs"><a href="javascript:void(0)" class="alacarte-li">À la carte meny</a>
                	...
                	<ul>
                    	<li class="nav-menu navs <?php echo showNav($nav_menu,'category*sub_category'); ?>" data-rel="nav-alacarte"><a href="?page=menu">Menynställningar</a>
                         <li class="nav-logs navs <?php echo showNav($nav_logs,''); ?>"><a href="?page=logs&parent=reports">Logg</a></li>
                    </ul>
                ...
                <?php if($_GET['page']!='dashboard'){ ?>
                <li class="navs" style="float:right;"><a href="#" onClick="logout()">Logga ut</a></li>
                <?php } ?>
            </ul>
        </div>
    </div>
